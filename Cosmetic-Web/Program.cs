...
using Cosmetic_Web.ExtendMethods;
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("RequireManageRole", policy => policy.Requirements.Add(new CustomAuthorizationRequirement("Manage")));
    options.AddPolicy("RequireSaleRole", policy => policy.Requirements.Add(new CustomAuthorizationRequirement("Sale")));
});
