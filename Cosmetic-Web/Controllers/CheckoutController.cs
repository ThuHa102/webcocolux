...
namespace Cosmetic_Web.Controllers
{
    public class CheckoutController : Controller
    {
        ...
        public async Task<IActionResult> Index(bool? paymentOneProduct, bool? paymentManyProduct)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> ProcessPayment(int productId, int quantity, int userId)
        {
            ...
            try
            {
                    ...
                    lineItems.Add(new SessionLineItemOptions
                    {
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            {
                                Name = $"Bạn đang thanh toán {totalItem} sản phẩm trên Cocolux"
                            },
