...
namespace Cosmetic_Web.Areas.Admin.Controllers
{
    ...
    public async Task<IActionResult> Details(int? id)
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Product product, IFormFileCollection files)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, Product product, IFormFileCollection files)
        {
